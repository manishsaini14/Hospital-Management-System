...
class Hospital:
    def __init__(self,root):
        ...
        btnPrescription =Button(Buttonframe,command=self.iPrescription,text="Prescription", bg="blue", fg="white",font=("arial",12,"bold"),width=23,height=1,padx=2,pady=6)
        btnPrescription.grid(row=0,column=0)

        btnPrescriptionData =Button(Buttonframe,text="Prescription Data", bg="blue", fg="white",font=("arial",12,"bold"),width=23,height=1,padx=2,pady=6,command=self.prescriptionDate)
        btnPrescriptionData.grid(row=0,column=1)

        btnUpdate =Button(Buttonframe,command=self.update_data,text="Update", bg="blue", fg="white",font=("arial",12,"bold"),width=23,height=1,padx=2,pady=6)
        btnUpdate.grid(row=0,column=2)

        btnDelete =Button(Buttonframe,command=self.delete_fun,text="Delete", bg="blue", fg="white",font=("arial",12,"bold"),width=23,height=1,padx=2,pady=6)
        btnDelete.grid(row=0,column=3)

        btnClear =Button(Buttonframe,command=self.clear,text="Clear", bg="blue", fg="white",font=("arial",12,"bold"),width=23,height=1,padx=2,pady=6)
        btnClear.grid(row=0,column=4)

        btnExit =Button(Buttonframe,command=self.Exit,text="Exit", bg="blue", fg="white",font=("arial",12,"bold"),width=23,height=1,padx=2,pady=6)
       ...
       # ========================================Scrollbar=============================================================
        ...
        self.hospital_table = ttk.Treeview(
            Detailsframe,
            columns=(
                "nameoftablet", "ref", "does", "nooftablets", "lot", "issuedate", "expdate",
                "dailydose", "sideeffect", "furtherinfo", "bloodpresure", "storage",
                "medication", "patientid", "nhsnumber", "pname", "dob", "address"
            ),
        ...
        self.hospital_table.heading("bloodpresure", text="Blood Pressure")
 ...
 # ====================== Database Function ======================
    def prescriptionDate(self):
        ...
        try:
            ...
            # Corrected SQL query
            sql_insert = "INSERT INTO hospital (name_of_tablets, reference_no, dose, numbers_of_tablets, lot, issue_date, exp_date, daily_dose, side_effect, further_info, blood_pressure, storage, medication, patient_id, nhs_number, patient_name, dob, patient_address) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
    ...
    def update_data(self):
        try:
            ...
            update_query = "UPDATE hospital SET name_of_tablets=%s, reference_no=%s, dose=%s, numbers_of_tablets=%s, lot=%s, issue_date=%s, exp_date=%s, daily_dose=%s, side_effect=%s, further_info=%s, blood_pressure=%s, storage=%s, medication=%s, patient_id=%s, nhs_number=%s, patient_name=%s, dob=%s, patient_address=%s WHERE reference_no=%s"
